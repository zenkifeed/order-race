...
/** Chuỗi -> byte UTF-8. KHÔNG tự chuẩn hoá; việc đó do lớp trên quyết định. */
...
export function sha256Bytes(input) {
  ...
  const bitLen = len * 8;
  dv.setUint32(padLen - 8, Math.floor(bitLen / 4294967296) >>> 0);
...
export function sha256HexOfString(str) {
